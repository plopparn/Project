...
HD_PWD='C:/Users/wipe1801/cpuyesklar/cpuyesklar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_top_module.tcl
