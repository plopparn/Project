...
HD_PWD='C:/Users/wipe1801/cpuyesklar/cpuyesklar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_top_module.tcl -notrace
